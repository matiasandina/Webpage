...
This is difficult to detect because it's a self-fulfilled profecy for scouts (after all, they want their picks to end up being good). Basketball doesn't have this kind of problems, mostly because its availability and the absence of cutoff dates. But in other sports, this is even more marked. In ice hockey, you are mostly constrained to the winter season and you need a rink to play[^science]. 
